...
#import "XXWebViewJavascriptBridgeJS.h"
...
@implementation XXWebViewJavascriptBridge {
    ...
    long _uniqueId;
    XXWebViewJavascriptBridgeBase *_base;
}

+ (void)enableLogging {
    [XXWebViewJavascriptBridgeBase enableLogging];
}
...
- (void) _setupInstance:(WKWebView*)webView {
    ...
    _base = [[XXWebViewJavascriptBridgeBase alloc] init];
    _base.delegate = self;
}
